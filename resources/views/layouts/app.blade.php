            ...
            <nav class="navbar navbar-expand-lg stroke">
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                    <ul class="navbar-nav ml-lg-auto">
                        ...
                        @if(Request::path()=="/")
                        <li class="nav-item ">
                            <a class="nav-link" href="{{ route('register') }}">Home <span
                        ...
                        <div class="search-right ml-lg-3">
                            <form action="{{ route('search_event') }}" method="GET"
                                ...
                                <div class="input-search">
                                    <input type="search" placeholder="Rechercher un évènement" name="q"
                        ...
                        <li class="nav-item">
                            <a class="nav-link"
                                style="background-color: #ffc107; padding-left: 8px; padding-right:8px; border-radius:6px"
                                href="{{ route('login') }}">
                                Connexion </a>
                        </li>
