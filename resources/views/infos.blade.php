...
<link rel="stylesheet" href="{{ asset('css/carousel.rlt.css') }}">
<style>
      .bd-placeholder-img {
        font-size: 1.125rem;
        text-anchor: middle;
            ...
            <div class="row w3l-features-photo-7_top align-items-center">
                ...
                <div class="col-lg-6 w3l-features-photo-7_top-right mt-lg-0 mt-sm-5 mt-4">
                    ...
                    <div class="carousel-item active">
                       ...
                       <img src="{{asset('images/hero_1.jpg')}}" alt="" class="bd-placeholder-img" width="100%" height="100%"><rect width="100%" height="100%" fill="#777"/>
                        <div class="container">
                    ...
                    <div class="carousel-item">
                        <svg class="bd-placeholder-img" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" preserveAspectRatio="xMidYMid slice" focusable="false"><rect width="100%" height="100%" fill="#777"/></svg>
                        <img src="{{asset('images/hero_2.jpg')}}" alt="" class="bd-placeholder-img" width="100%" height="100%"><rect width="100%" height="100%" fill="#777"/>
                        <div class="container">
                    ...
                    <div class="carousel-item">
                        <svg class="bd-placeholder-img" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" preserveAspectRatio="xMidYMid slice" focusable="false"><rect width="100%" height="100%" fill="#777"/></svg>
                        <img src="{{asset('images/hero_3.jpg')}}" alt="" class="bd-placeholder-img" width="100%" height="100%"><rect width="100%" height="100%" fill="#777"/>
                        <div class="container">
